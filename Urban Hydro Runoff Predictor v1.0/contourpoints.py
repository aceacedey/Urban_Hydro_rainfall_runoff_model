...
class dragworking():
    ...
    def coordinates(self,click):
        ...
        self.x,self.y=str((click.x - self.ChangeDx)*self.counter*self.t ),str((click.y - self.ChangeDy)* self.counter*self.t)
    ...
    def see(self):
        ...
        ws = wb.active
        for z in range(self.i):
                  ws.append((self.a[z],self.b[z]))
                  z+=1
        wb.save('contourN.xlsx')
